...
public class MainActivity extends Activity implements SelectionListener,
    ...
    //.setAllowUserClicks created in FriendsFragment
    ...
    // Method created in SelectionListener
	...
	protected void onSaveInstanceState(Bundle savedInstanceState) {
        //putString() - Inserts a String value into the mapping of this Bundle,
        //replacing any existing value for the given key.

        //getTag() - Get the tag name of the fragment, if specified.
        //String Tag passed when fragment is .add() or .replace()

        //If a fragment returns data, map it to Bundle
